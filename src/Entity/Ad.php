...
class Ad
{
     ...
     * @Assert\Length(min="10", max="255", minMessage="Le titre doit faire plus de 10 caractères", maxMessage="le titre ne peut exceder plus de 255 caractères")
     */
    private $title;
     ...
     * @Assert\Length(min=20, maxMessage="le titre doit faire plus de 20 caractères")
     */
    ...
    public function getNotAvailableDays()
    {
        ...
        foreach ($this->bookings as $booking) {
            ...
            $resultat = range(
                $booking->getStartTime()->getTimestamp(),
