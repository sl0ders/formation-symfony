 ...
 * @UniqueEntity(
 *     fields={"email"},
 *     message="Un autre utilisateur s'est deja inscrit avec cette addresse email, merci de le modifier"
 * )
 */
class User implements UserInterface
{
    ...
    /**
     * @Assert\EqualTo(propertyPath="hash",message="le mot de passe doit etre identique a sa confirmation")
     */
